...
<template>
  <div class="w-full">
    <div class="flex justify-between mb-20px">
      <div class="p-20px bg-basic-box w-19 text-center rounded-lg">
        <div class="mb-2">
          <img src="@/assets/image/dash-1.png" alt="dash-1" class="m-auto" />
        </div>
        <el-tooltip
          effect="dark"
      ...
      <div class="p-20px bg-basic-box w-19 text-center rounded-lg">
        <div class="mb-2">
          <img src="@/assets/image/dash-2.png" alt="dash-2" class="m-auto" />
        </div>
        <el-tooltip
          effect="dark"
      ...
      <div class="p-20px bg-basic-box w-19 text-center rounded-lg">
        <div class="mb-2">
          <img src="@/assets/image/dash-3.png" alt="dash-3" class="m-auto" />
        </div>
        <el-tooltip
          effect="dark"
      ...
      <div class="p-20px bg-basic-box w-19 text-center rounded-lg">
        <div class="mb-2">
          <img src="@/assets/image/dash-4.png" alt="dash-4" class="m-auto" />
        </div>
        <el-tooltip
          effect="dark"
      ...
      <div class="p-20px bg-basic-box w-19 text-center rounded-lg">
        <div class="mb-2">
          <img src="@/assets/image/dash-5.png" alt="dash-5" class="m-auto" />
        </div>
        <el-tooltip
          effect="dark"
    ...
    <div class="w-full flex justify-between mb-20px">
      <div
        id="ecosystemRef"
        ref="ecosystemRef"
        class="w-49 bg-basic-box rounded-lg"
      >
        <el-scrollbar :max-height="heightBox" @scroll="handleDaoScroll">
          <div ref="ecosystemScroll" class="p-20px">
            <div
              ...
              :class="{
                'border-b border-basic pb-3 mb-6 font-semibold': item.id === 1
              }"
            >
              <div>{{ item.name }}</div>
              <div>
      ...
      <div class="w-49 p-20px bg-basic-box rounded-lg">
        <h4 class="font-semibold mb-3">{{ $t('home.survey') }}</h4>
