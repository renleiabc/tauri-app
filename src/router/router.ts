...
const routes = [
    ...
    children: [
      {
        ...
        name: 'Assets',
        component: () =>
          import(/* webpackChunkName: "assets" */ '@/pages/assets/assets.vue'),
        meta: {
          key: '2-1',
          title: 'nav.assets'
        }
      ...
      },
      {
        ...
        name: 'Record',
        component: () =>
          import(/* webpackChunkName: "assets" */ '@/pages/assets/record.vue'),
        meta: {
          key: '2-3',
          title: 'nav.assets'
        }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'NFTDetails',
        component: () =>
          import(/* webpackChunkName: "nft" */ '@/pages/nft/nftDetails.vue'),
        meta: {
          key: '3-2',
          title: 'nft.list'
        }
  ...
  },
  {
    path: '/ethereum',
    component: () =>
      import(/* webpackChunkName: "ethereum" */ '@/pages/ethereum/index.vue'),
    meta: {
      key: '4',
      title: 'nav.eth'
    },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'HonorId',
        component: () =>
          import(/* webpackChunkName: "honor" */ '@/pages/honor/honorId.vue'),
        meta: {
          key: '5-2',
          title: 'nav.eth'
        }
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'HelpDetails',
        component: () =>
          import(/* webpackChunkName: "help" */ '@/pages/help/helpDetails.vue'),
        meta: {
          key: '7-2',
          title: 'nav.massage'
        }
